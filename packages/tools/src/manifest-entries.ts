...
import { defineCodeReplTools } from "./extensions/code-repl/tools.js";
import { defineDeepResearchTools } from "./extensions/deep-research/tools.js";
import { defineWorkMemTools } from "./extensions/work-mem/tools.js";
import type { ToolManifestEntry } from "./define-tool.js";
...
/** Optional built-in plugin tools (code_repl, deep_research, work_mem). */
...
export const DEFAULT_TOOL_MANIFEST: ToolManifestEntry[] = [
