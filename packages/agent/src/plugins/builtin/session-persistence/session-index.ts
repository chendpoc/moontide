import { sessionIndexPath, sessionLogPath, sessionsDir } from "@moontide/session";
import { ensureDirForFile, readJson, writeJsonPretty } from "@moontide/shared/storage/fs.js";
import { exists, fileSize, listDir, readLines, stat } from "@moontide/shared/utils/fs.js";
import type {
  SessionIndex,
  SessionIndexEntry,
  SessionListEntry,
