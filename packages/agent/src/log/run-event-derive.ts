...
import { emit, finalizeRunOutputs } from "./event-hub.js";
import type { EventDraft } from "./types.js";
import { getRunId, resetRun } from "./run.js";
...
export function createRunEventDeriveListener(
	options: RunEventDeriveOptions = {},
): RunEventListener {
	let turn = 0;
