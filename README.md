...
正在重建内核 crate [`crates/moontide-agent-core`](crates/moontide-agent-core/README.md)，按依赖顺序逐模块推进。

**当前模块：`llm`** — MoonTide 协议类型 + `LLMProvider` + adapter / normalize。设计与实现见 [`crates/moontide-agent-core/src/llm/README.md`](crates/moontide-agent-core/src/llm/README.md)。
...
推进顺序与 checklist：[`crates/moontide-agent-core/README.md`](crates/moontide-agent-core/README.md)。
...
| 内核落地 | [`crates/moontide-agent-core/README.md`](crates/moontide-agent-core/README.md) | 模块依赖顺序与 checklist |
