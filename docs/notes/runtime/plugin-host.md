...
TS 仓库：现有 tests + fixture manifest 作 **conformance**；[`ToolRegistry`](../../../packages/tools/src/registry.ts) 行为对齐 registry 语义。
...
- **TS harness（已实现）：**
  ...
  - [`packages/tools/src/registry.ts`](../../../packages/tools/src/registry.ts) — tool registry
