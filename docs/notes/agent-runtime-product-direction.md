...
> **状态：** 2026-08 讨论稿  
> **关联：** [`agent-core-design`](../agent-core-design.md) · [`agent-core-roadmap`](agent-core-roadmap.md) · [`platform-strategy`](../product/platform-strategy.md) · [`spark`](../product/spark.md) · [`vision`](../product/vision.md)
