...
> **关联：** [Feature Eval PR 计划（agent-eval-roadmap §6）](../evals/agent-eval-roadmap.md) · [`packages/evals/`](../../../packages/evals/) · [TODO.md](../../../TODO.md)

本文记录 **API 适配层** 中刻意移出 Feature Eval PR 流水线的工作项。eval 计划 Phase 3 仅做 judge 路径整理与 `adapterFamily` 分发；下列条目在 eval 流水线完成后或并行按 §13 分期推进。
