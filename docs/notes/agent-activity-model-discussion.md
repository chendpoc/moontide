...
> **关联：** [`context-window-roadmap.md`](context-window-roadmap.md) §7 · §8.2 · [`context-backlog.md`](context-backlog.md) §8 · [`TODO.md`](../../TODO.md) §15.2 · [`context-analysis.md`](context-analysis.md) · [`session-handoff.md`](session-handoff.md) · [`deep-mode.md`](deep-mode.md)
...
- [ ] Sidecar explore：与 [`plugin-host.md`](plugin-host.md) / sidecar supervisor 如何挂钩？
...
| Deep Mode / Working Set | `src/agent/deep-mode.ts` · `docs/notes/deep-mode.md` |
