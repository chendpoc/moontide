...
| [`agent-run-hooks.md`](../runtime/agent-run-hooks.md) | `runFinalize`、hook mode 与 sidecar/plugin 边界 |
| [`plugin-host.md`](../runtime/plugin-host.md) | process-scoped builtin plugin / worker 承载方式 |
...
| [`session-handoff.md`](../session/session-handoff.md) | redaction、export 与数据外泄边界 |
