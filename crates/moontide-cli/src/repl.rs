...
use moontide_observability::{error_line, session_line, startup_banner, ObservabilityState};
use moontide_tools::AlwaysAllowState;
...
pub async fn run_repl(
    ...
    loop {
        let prompt = format!("MoonTide [{}]> ", agent.session.session_id);
