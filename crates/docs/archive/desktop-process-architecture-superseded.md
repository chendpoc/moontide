...
> **替代设计：** [`../../moontide-desktop/DESIGN.md`](../../moontide-desktop/DESIGN.md)
> **历史实现设计：** [`../../moontide-desktop/DESIGN.md`](../../moontide-desktop/DESIGN.md)（integrated runtime 取代独立 `desktop` crate）
