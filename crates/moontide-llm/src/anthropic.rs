...
use moontide_protocol::{ContentBlock, Message, MessageContent, ToolSchema};
use reqwest::Client;
...
impl LlmClient for AnthropicClient {
    async fn chat(
        ...
        let api_messages: Vec<ApiMessage> = messages
            ...
            .map(|m| ApiMessage {
                role: match m.role {
                    moontide_protocol::Role::User => "user".into(),
                    moontide_protocol::Role::Assistant => "assistant".into(),
                },
    ...
    match block {
        ...
        ContentBlock::ToolResult {
            ...
            let content_val = match content {
                moontide_protocol::ToolResultContent::Text(t) => Value::String(t.clone()),
                moontide_protocol::ToolResultContent::Blocks(b) => {
