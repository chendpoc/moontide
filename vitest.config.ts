...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{
				find: "@moontide/agent/observability",
				replacement: path.resolve(root, "packages/agent/src/observability.ts"),
			},
			{
				find: "@moontide/agent",
			...
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/session/src/block-registry.ts",
				),
			},
			{
			...
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/context-composer/src/ports/index.ts",
				),
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/context-composer/src/budget/index.ts",
				),
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/context-composer/src/compaction/operations.ts",
				),
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/context-composer/src/index.ts",
				),
			},
			{
			...
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/tools/src/builtins/workspace/fs.ts",
				),
			},
			{
				find: "@moontide/tools",
			...
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/sidecar-host/src/ports/index.ts",
				),
			},
			{
			...
			},
			{
				...
				replacement: path.resolve(
					root,
					"packages/agent-cli/src/bootstrap-env.ts",
				),
			},
			{
